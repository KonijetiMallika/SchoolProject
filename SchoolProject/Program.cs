...
class Program
{
    static void Main()
    {
        ...
        repository.AddStudent(new Student { Name = "likitha", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "pravallika", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "begam", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "sameer", ClassAndSection = "ClassA" });
        repository.AddStudent(new Student { Name = "anvitha", ClassAndSection = "ClassA" });

        repository.AddStudent(new Student { Name = "kanaka", ClassAndSection = "ClassB" });
        repository.AddStudent(new Student { Name = "ratna", ClassAndSection = "ClassB" });
        repository.AddStudent(new Student { Name = "mounika", ClassAndSection = "ClassB" });
        repository.AddStudent(new Student { Name = "mallika", ClassAndSection = "ClassB" });
